    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="overflow-x-auto bg-white rounded-lg shadow">
            <table class="w-full table-auto">
                ...
                {classes.map((classe)=>(
                    <tr key={classe.id} onClick={()=>{navigate(`/dashboard/studentlist/${classe.id}`)}} class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 text-center">
                            <div  class="flex item-center justify-center">
                                <button class="w-4 mr-2 transform hover:text-blue-500 hover:scale-110" onClick={(e)=>{
                                    e.stopPropagation();
                                    navigate(`/dashboard/editclass/${classe.id}`)
                                }}>
